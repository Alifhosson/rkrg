module.exports.config = {
  ...
  permission: 0,
  credits: "Nayan",
  description: "Add text on a user's profile picture",
  prefix: true,
  category: "Fun", 
  usages: "user", 
  cooldowns: 5,
...
module.exports.run = async function ({ args, Users, Threads, api, event, Currencies }) {
  ...
  const getAvtmot = (await axios.get(`https://graph.facebook.com/${id}/picture?width=720&height=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`, { responseType: "arraybuffer" })).data;
  ...
  lines.forEach((line, index) => {
    ctx.fillText(line, 200, 497 + index * 25); // Adjust Y position as needed
  });
